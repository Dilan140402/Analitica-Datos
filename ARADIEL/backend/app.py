...
# ============================================================
# 9. Endpoint: Recomendaciones de redistribución
# ============================================================
...
# ============================================================
# 6. Endpoint: Data histórica completa
# ============================================================

@app.route('/api/history', methods=['GET'])
def api_history():
    """Devuelve toda la base de datos histórica"""
    df = load_full_history()
    return jsonify(df.to_dict(orient='records'))


# ============================================================
# 7. Endpoint: Estimar ruta (API pública OSRM)
# ============================================================
...
# ============================================================
# 8. Tarea programada: tomar snapshot cada 5 minutos
# ============================================================
